...
function TrackRow({ track, index }: { track: Track; index: number }) {
  return (
    <div className='flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors'>
      ...
      <div className='w-10 h-10 rounded-lg bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/30 dark:to-indigo-900/30 flex items-center justify-center flex-shrink-0'>
        {track.coverImageUrl ? (
          <img
...
function UpgradeCard() {
  ...
  return (
    <div className='rounded-xl border border-purple-100 dark:border-purple-800/40 bg-purple-50 dark:bg-purple-900/10 p-5'>
      <div className='flex items-start gap-4'>
        ...
        <div className='flex-1'>
          ...
          <button
            ...
            className='text-xs font-semibold px-4 py-2 rounded-lg bg-purple-600 text-white hover:bg-purple-700 transition-colors'
          >
            Get Started →
          </button>
        </div>
