  ...
  return (
    <div className='space-y-8'>
      ...
      <div className='fixed bottom-6 right-6 z-50'>
        <button className='group bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center gap-3 shadow-lg hover:shadow-xl hover:scale-105'>
      ...
      <div className='bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700'>
        <div className='p-8'>
          ...
          <p className='text-gray-500 dark:text-gray-400 mb-8'>
            Drag and drop your music files here or click to browse. Supports
            MP3, WAV, FLAC, M4A, and AAC files up to 100MB.
          </p>
          ...
          <div className='p-6'>
            <div className='space-y-4'>
              {uploadedFiles.map(uploadedFile => (
                <div
                  key={uploadedFile.id}
                  className='flex items-center space-x-4 p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg'
                >
