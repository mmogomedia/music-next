          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group">
                ...
                <div className="text-3xl font-bold text-gray-900 dark:text-white mb-1">{stats.totalTracks}</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Total Tracks</div>
                <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">+2 this month</div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group">
                ...
                <div className="text-3xl font-bold text-gray-900 dark:text-white mb-1">{stats.totalPlays.toLocaleString()}</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Total Plays</div>
                <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">15,420 this month</div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group">
                ...
                <div className="text-3xl font-bold text-gray-900 dark:text-white mb-1">{stats.totalLikes.toLocaleString()}</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Total Likes</div>
                <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">892 this month</div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group">
                ...
                <div className="text-xs text-gray-400 dark:text-gray-500 mt-1">$247.50 this month</div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700">
              <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Recent Tracks</h3>
              ...
              <div className="divide-y divide-gray-200 dark:divide-slate-700">
                {recentTracks.map((track) => (
                  <div key={track.id} className="p-6 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors duration-200 group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">Upload New Track</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Share your latest music with the world</p>
                  </div>
                </div>
                <button 
                  onClick={() => setActiveTab('upload')}
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">View Analytics</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Track your performance and growth</p>
                  </div>
                </div>
                <button 
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 hover:shadow-lg transition-all duration-200 group">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-pink-600 dark:group-hover:text-pink-400 transition-colors duration-200">Create Smart Links</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Generate cross-platform sharing links</p>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700">
              <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Track your music performance and audience</p>
              </div>
              <div className="p-8">
                <div className="text-center py-12">
                  ...
                  <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Analytics Coming Soon</h4>
