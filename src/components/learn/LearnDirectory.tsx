/**
 * The Learn directory — the browsable index of guides.
 *
 * Rendered by `src/app/learn/page.tsx`:
 *   /learn           → cluster hub
 *   /learn?view=grid → paginated article grid with cluster filters
 *
 * The marketing landing page owns `/`. Individual guides are NOT nested here —
 * they live at `/:slug`, with topics at `/topic/:slug`.
 */
