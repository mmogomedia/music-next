...
export default function TrackLandingView({
  ...
  const handleDownload = async () => {
    if (track.isDownloadable === false || !track.fileUrl) {
  ...
  return (
    <div className='rounded-[32px] border border-slate-200 bg-white shadow-[0_35px_100px_-50px_rgba(15,23,42,0.25)] overflow-hidden'>
        ...
        <div className='flex-1 p-6 sm:p-8 space-y-6 bg-white'>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            ...
            <Button
              ...
              isDisabled={track.isDownloadable === false}
              ...
              <div className='flex flex-wrap gap-2'>
                {track.streamingLinks.map(link => (
                  <a
                    ...
                    className='inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm text-slate-700 hover:border-blue-400 hover:text-blue-600 transition-colors'
