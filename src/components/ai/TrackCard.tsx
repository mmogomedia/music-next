...
const STREAMING_PLATFORMS: Record<
  string,
...
function StreamingLinks({
  ...
  const visible = links.filter(l => l.platform in STREAMING_PLATFORMS);
      ...
      {visible.map(link => {
        ...
        return (
          <a
            ...
            className='flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold hover:opacity-80 transition-opacity whitespace-nowrap'
          >
