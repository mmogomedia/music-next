...
export default function HomePage() {
  ...
  const topHits = [
    { rank: 1, title: 'Greedy', artist: 'Tate McRae', duration: '02:11' },
    {
      ...
      artist: 'The Weeknd, Jennie & Lily Ro...',
      duration: '03:45',
    },
    {
      rank: 3,
      title: 'Popular',
      artist: 'The Weeknd, Playboi Carti an...',
      duration: '04:02',
    },
    {
      rank: 4,
            ...
            <div className='bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700'>
              ...
              <div className='space-y-3'>
                {topHits.map(track => (
                  <div
                    key={track.rank}
                    className='flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors duration-200 cursor-pointer group'
                  >
            ...
            <div className='bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700'>
              ...
              <div className='space-y-3'>
                {justForYou.map((track, index) => (
                  <div
                    key={index}
                    className='flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors duration-200 cursor-pointer group'
                  >
