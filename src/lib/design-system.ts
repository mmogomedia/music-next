  ...
  components: {
    button: {
      ...
      variants: {
        ...
        secondary: 'bg-secondary text-black hover:bg-secondary/90 shadow-glowSecondary',
...
export const getColor = (color: string) => designSystem.brand[color as keyof typeof designSystem.brand] || color
export const getShadow = (size: keyof typeof designSystem.shadows) => designSystem.shadows[size]
export const getGradient = (type: keyof typeof designSystem.gradients) => designSystem.gradients[type]
